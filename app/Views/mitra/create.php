...
<?= $this->section('title') ?>
Tambah Mitra Kerja Baru
<?= $this->endSection() ?>

<?= $this->section('content') ?>

<!-- HEADER KONTEN (Style Ringkas) -->
<div class="mb-4 p-3 border-bottom">
    <h1 class="display-6 fw-bold mb-1 text-dark">
        <i class="fas fa-plus-circle me-2 text-primary"></i> Tambah Mitra Kerja Baru
    </h1>
    <p class="lead text-muted">
        Masukkan detail lengkap perusahaan yang menjalin kemitraan dengan Puskopal.
    </p>
</div>

<div class="card shadow mb-4">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Formulir Data Perusahaan Mitra</h5>
    </div>
    <div class="card-body">

        <!-- Formulir untuk menyimpan data Mitra -->
        <form action="<?= site_url('mitra/store') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row">
                ...
                <!-- KOLOM KIRI: DETAIL UTAMA & ALAMAT -->
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_mitra" id="nama_mitra"
                            ...
                            value="<?= old('nama_mitra') ?>" placeholder="Contoh: PT. Sinar Abadi Jaya" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="4" class="form-control"
                            placeholder="Catatan mengenai riwayat kerjasama, preferensi, atau info penting lainnya."><?= old('keterangan') ?></textarea>
                    </div>

                </div>

                <!-- KOLOM KANAN: DETAIL KONTAK & STATUS -->
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pic" id="pic"
                            ...
                            value="<?= old('pic') ?>" placeholder="Nama penanggung jawab di perusahaan mitra">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            value="<?= old('email') ?>" placeholder="Contoh: kontak@perusahaanmitra.com" required>
            ...
            <hr class="mt-4">
            <!-- Tombol Submit dan Batal (Style Aset Tanah/Bangunan) -->
            <button type="submit" class="btn btn-success btn-lg shadow-sm me-2">
                <i class="fas fa-save me-1"></i> Simpan Data Mitra
            </button>
            <a href="<?= site_url('mitra') ?>" class="btn btn-secondary btn-lg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (alertElement) {
        setTimeout(function() {
            // Pastikan bootstrap dimuat untuk menggunakan fungsi alert
            if (typeof bootstrap !== 'undefined' && bootstrap.Alert) {
                const bootstrapAlert = bootstrap.Alert.getOrCreateInstance(alertElement);
                bootstrapAlert.close();
            } else {
                // Fallback jika bootstrap.js belum dimuat
