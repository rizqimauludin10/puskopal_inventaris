...
<div class="row mb-3">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="kendaraanTable" class="table table-bordered table-striped" width="100%" cellspacing="0">
                    ...
                    if ($row['pajak_setahun'] == '0000-00-00' || empty($row['pajak_setahun'])) {
                        $statusLabel = 'Tidak Ditentukan';
                        $statusClass = 'secondary';
                    } else {
                        $today = new DateTime();
                        $masaBerlaku = new DateTime($row['pajak_setahun']);
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $row['pajak_setahun'] == '0000-00-00' ? '-' : date('d-m-Y', strtotime($row['pajak_setahun'])) ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data aset kendaraan **<span id="asetNopol"
                        class="fw-bold"></span>**
                    secara permanen?
    ...
    $(document).ready(function() {
        ...
        // Gunakan event delegation agar tetap berfungsi di semua halaman DataTables
